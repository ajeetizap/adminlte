                          ...
                          <table>
                              ...
                              while($rows = $sql->fetch_assoc()) {
                                  ...
                                  if ($_SESSION['user_id'] == $rows['id']) {
                                      ...
                                      echo "<td> <a href='user_list.php?update_user=$rows[id]'><input type='button'  value='edit'></a><br /></td>";
                                      echo "<td> <a href='user_list.php?delete_user=$rows[id]' onClick=\"return confirm('Are you sure you want to delete?');\"><input type='button'  value='drop'  ></a><br /></td>";
