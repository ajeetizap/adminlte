                                ...
                                while($rows = $sql->fetch_assoc())
                                    {
                                        ...
                                        echo "<td> <a href='items_list.php?update=$rows[id]'>edit<br /></td>";
                                        echo "<td> <a href='items_list.php?delete=$rows[id]' onClick=\"return confirm('Are you sure you want to delete?');\">drop<br /></td>";
                                        echo "</tr>";
